namespace KitsorLab.PushServer.API.Attributes
{
	using System;
	...
	///
	/// https://stackoverflow.com/questions/26354853/conditionally-required-property-using-data-annotations#27666044
	/// 
	/// <summary>
